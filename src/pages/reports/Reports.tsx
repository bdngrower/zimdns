                ...
                <div className="border-b border-slate-200 p-5 flex flex-wrap items-center gap-4 bg-white">
                    <div className="relative flex-1 min-w-[280px]">
                        ...
                        <input
                            ...
                            className="block w-full rounded-lg border-0 py-2.5 pl-10 text-slate-500 ring-1 ring-inset ring-slate-200 bg-slate-50 placeholder:text-slate-400 focus:ring-2 focus:ring-inset focus:ring-accent sm:text-sm sm:leading-6 cursor-not-allowed transition-all"
                            placeholder="Buscar domínios, IPs ou perfis de cliente..."
                        />
                    </div>
                    <div className="flex items-center gap-3">
                        <select disabled className="rounded-lg border-0 py-2.5 pl-3 pr-10 text-slate-500 ring-1 ring-inset ring-slate-200 bg-slate-50 sm:text-sm cursor-not-allowed hidden sm:block">
                            <option>Todos os Eventos</option>
                        </select>
                        <select disabled className="rounded-lg border-0 py-2.5 pl-3 pr-10 text-slate-500 ring-1 ring-inset ring-slate-200 bg-slate-50 sm:text-sm cursor-not-allowed hidden md:block">
                                ...
                                <td colSpan={4} className="py-32">
                                    <div className="flex flex-col items-center justify-center max-w-lg mx-auto text-center px-4">
                                        ...
                                        <p className="mt-2 text-sm text-slate-500 leading-relaxed">
                                            O pipeline global de auditoria consolida tráfego apenas quando as políticas resultarem em ações explícitas na borda. No momento, não há tráfego volumétrico ativo ou interceptação gravada na janela de tempo selecionada.
                                        </p>
